...
namespace SetupComputerVariables
{
    public partial class Form1 : Form
    {
        ...
        private void button_SetupComputer_Click( object sender, EventArgs e )
        {
            ...
            {
                richTextBox_Status.Text += "\nCannot do the work, some variables are bad.  Please fix them and press 'Setup Computer' again.\n";
            }
        }
        ...
        {
            saveFileDialog_Variables.FileName = RPathToVariablesFile.GetFullPath( );
